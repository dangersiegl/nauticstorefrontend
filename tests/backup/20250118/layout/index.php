...
$categories = [
    [
        ...
        'subcategories' => [
            ...
            'Anker',
            'Ankerketten',
            'Fender & Bojen & weitere nützliche Dinge',
            'Festmacher',
        ]
    ],
    [
...
// Array von Beispielprodukten für jede Kategorie definieren
$categoryProducts = [
    'Ankern & Belegen' => [
        'name' => 'Anker Deluxe',
        'price' => '99,99',
        ...
        'image' => 'anker.jpg',
        'discount' => '23',
        'description' => 'Hochwertiger Edelstahlanker, ideal für alle Boote.'
    ],
    'Bekleidung' => [
        'name' => 'Segeljacke Profi',
        'price' => '149,99',
        'old_price' => '199,99',
        'image' => 'segeljacke.jpg',
        'discount' => '25',
        'description' => 'Wasserdicht und atmungsaktiv, perfekt für alle Wetterlagen.'
    ],
    'Elektrik' => [
        'name' => 'Bordbatterie 12V',
        'price' => '79,99',
        'old_price' => '99,99',
        'image' => 'bordbatterie.jpg',
        'discount' => '20',
        'description' => 'Zuverlässige Energiequelle für alle Systeme an Bord.'
    ],
    // Weitere Kategorien und Produkte hinzufügen...
];
?>
<!DOCTYPE html>
<html lang="de">
...
<body>
                                    ...
                                    <div class="mega-menu-content">
                                        ...
                                        <div class="mega-menu-left">
                                            ...
                                            <ul class="subcat-list">
                                                <?php foreach ($catData['subcategories'] as $index => $subcat): ?>
                                                    <?php if ($index > 0 && $index % 10 === 0): ?>
                                                        </ul><ul class="subcat-list">
                                                    <?php endif; ?>
                                                    <li><a href="#"><?= htmlspecialchars($subcat) ?></a></li>
                                                <?php endforeach; ?>
                                            </ul>
                                        </div>
                                <!-- Rechte Spalte: Beispielprodukt -->
                                <div class="mega-menu-right">
                                    <?php
                                    // Produktdaten basierend auf der Kategorie aus dem PHP-Array abrufen
                                    $currentCategory = $catData['name']; // Aktuelle Kategorie auslesen
                                    $product = $categoryProducts[$currentCategory] ?? null; // Produktdaten holen

                                    if ($product): ?>
                                        <div class="product-item product-item-small">
                                            <div class="discount-label-small">-<?= htmlspecialchars($product['discount']) ?>%</div>
                                            <a href="#">
                                                <img src="<?= htmlspecialchars($product['image']) ?>" alt="<?= htmlspecialchars($product['name']) ?>" loading="lazy" class="product-image-small">
                                    ...
                                    <?php else: ?>
                                    <div class="product-item product-item-small">
                                        <div class="discount-label-small">-20%</div>
                                        <a href="#">
                                            <img src="product01.png" alt="<?= htmlspecialchars($product['name']) ?>" loading="lazy" class="product-image-small">
                                            <h3 class="product-name-small">Beispielprodukt-Name</h3>
                                            <p class="description product-description-small">Kurzbeschreibung des Produkts oder ein Werbetext.</p>
                                            <div class="price-container">
                                                <span class="current-price">ab € 49,99</span>
                                                <span class="old-price">statt: € 59,99</span>
                                            </div>
                                        </a>
                                    </div>
                                <?php endif; ?>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const slideInterval = 7000; // Wechsel alle x Sekunden
    ...
    <!-- 4) Brand-Slider-Autoplay (unverändert aus deinem Code) -->
    <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Button ein- und ausblenden, je nach Scrollposition
